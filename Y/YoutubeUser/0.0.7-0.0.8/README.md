# Comparing `tmp/youtubeuser-0.0.7.tar.gz` & `tmp/youtubeuser-0.0.8.tar.gz`
...
## Comparing `youtubeuser-0.0.7.tar` & `youtubeuser-0.0.8.tar`
...
### Comparing `youtubeuser-0.0.7/YoutubeUser/getUser.py` & `youtubeuser-0.0.8/youtubeuser/getUser.py`

 * *Files identical despite different names*

### Comparing `youtubeuser-0.0.7/pyproject.toml` & `youtubeuser-0.0.8/pyproject.toml`
...
### Comparing `youtubeuser-0.0.7/setup.py` & `youtubeuser-0.0.8/setup.py`
