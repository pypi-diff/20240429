# Comparing `tmp/notolog-0.9.0b1.tar.gz` & `tmp/notolog-0.9.0b2.tar.gz`
...
### Comparing `notolog-0.9.0b1/tests/test_file_header.py` & `notolog-0.9.0b2/tests/test_file_header.py`
