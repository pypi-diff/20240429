# Comparing `tmp/nvidia_dali_tf_plugin_cuda110-1.36.0.tar.gz` & `tmp/nvidia_dali_tf_plugin_cuda110-1.37.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "nvidia_dali_tf_plugin_cuda110-1.36.0.tar", last modified: Mon Apr  5 07:00:00 1993, max compression
+gzip compressed data, was "nvidia_dali_tf_plugin_cuda110-1.37.0.tar", last modified: Mon Apr  5 07:00:00 1993, max compression
```

## Comparing `nvidia_dali_tf_plugin_cuda110-1.36.0.tar` & `nvidia_dali_tf_plugin_cuda110-1.37.0.tar`
...
-Version: 1.36.0
-Summary: NVIDIA DALI  TensorFlow plugin for CUDA 11.0. Git SHA: e2ae685702638e3f8fae8091344f0f7ea045a1f9
+Version: 1.37.0
