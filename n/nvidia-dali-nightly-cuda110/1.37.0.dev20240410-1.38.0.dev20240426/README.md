# Comparing `tmp/nvidia_dali_nightly_cuda110-1.37.0.dev20240410.tar.gz` & `tmp/nvidia_dali_nightly_cuda110-1.38.0.dev20240426.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "nvidia_dali_nightly_cuda110-1.37.0.dev20240410.tar", last modified: Mon Apr  5 07:00:00 1993, max compression
+gzip compressed data, was "nvidia_dali_nightly_cuda110-1.38.0.dev20240426.tar", last modified: Mon Apr  5 07:00:00 1993, max compression
```

## Comparing `nvidia_dali_nightly_cuda110-1.37.0.dev20240410.tar` & `nvidia_dali_nightly_cuda110-1.38.0.dev20240426.tar`
...
-Summary: NVIDIA DALI nightly  for CUDA 11.0. Git SHA: dedcfaec349c85387969bb78bda5d50aa61a4fa9
+Version: 1.38.0.dev20240426
+Summary: NVIDIA DALI nightly  for CUDA 11.0. Git SHA: 15f591232e2d068a76f1658ac7e3ea28b5622822
