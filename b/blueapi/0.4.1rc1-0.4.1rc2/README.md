# Comparing `tmp/blueapi-0.4.1rc1.tar.gz` & `tmp/blueapi-0.4.1rc2.tar.gz`
...
### Comparing `blueapi-0.4.1rc1/README.md` & `blueapi-0.4.1rc2/README.md`
...
### Comparing `blueapi-0.4.1rc1/docs/index.md` & `blueapi-0.4.1rc2/docs/index.md`
...
### Comparing `blueapi-0.4.1rc1/helm/blueapi/templates/tests/test-ping.yaml` & `blueapi-0.4.1rc2/helm/blueapi/templates/tests/test-ping.yaml`
...
### Comparing `blueapi-0.4.1rc1/src/blueapi.egg-info/SOURCES.txt` & `blueapi-0.4.1rc2/src/blueapi.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/conftest.py` & `blueapi-0.4.1rc2/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/core/fake_device_module.py` & `blueapi-0.4.1rc2/tests/core/fake_device_module.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/core/test_context.py` & `blueapi-0.4.1rc2/tests/core/test_context.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/core/test_event.py` & `blueapi-0.4.1rc2/tests/core/test_event.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/data_management/test_visit_directory_provider.py` & `blueapi-0.4.1rc2/tests/data_management/test_visit_directory_provider.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/messaging/test_stomptemplate.py` & `blueapi-0.4.1rc2/tests/messaging/test_stomptemplate.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/messaging/test_utils.py` & `blueapi-0.4.1rc2/tests/messaging/test_utils.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/preprocessors/test_attach_metadata.py` & `blueapi-0.4.1rc2/tests/preprocessors/test_attach_metadata.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/service/test_handler.py` & `blueapi-0.4.1rc2/tests/service/test_handler.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/service/test_openapi.py` & `blueapi-0.4.1rc2/tests/service/test_openapi.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/service/test_rest_api.py` & `blueapi-0.4.1rc2/tests/service/test_rest_api.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/service/test_subprocess_handler.py` & `blueapi-0.4.1rc2/tests/service/test_subprocess_handler.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/test_cli.py` & `blueapi-0.4.1rc2/tests/test_cli.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/test_config.py` & `blueapi-0.4.1rc2/tests/test_config.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/utils/test_ophyd_async_connect.py` & `blueapi-0.4.1rc2/tests/utils/test_ophyd_async_connect.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/utils/test_thread_exception.py` & `blueapi-0.4.1rc2/tests/utils/test_thread_exception.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/worker/devices.py` & `blueapi-0.4.1rc2/tests/worker/devices.py`

 * *Files identical despite different names*

### Comparing `blueapi-0.4.1rc1/tests/worker/test_reworker.py` & `blueapi-0.4.1rc2/tests/worker/test_reworker.py`
