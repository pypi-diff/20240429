# Comparing `tmp/mfprocess-0.0.4.tar.gz` & `tmp/mfprocess-0.0.5.tar.gz`
...
## Comparing `mfprocess-0.0.4.tar` & `mfprocess-0.0.5.tar`
...
### Comparing `mfprocess-0.0.4/LICENCE` & `mfprocess-0.0.5/LICENCE`

 * *Files identical despite different names*

### Comparing `mfprocess-0.0.4/PKG-INFO` & `mfprocess-0.0.5/PKG-INFO`
...
### Comparing `mfprocess-0.0.4/mfprocess.egg-info/PKG-INFO` & `mfprocess-0.0.5/mfprocess.egg-info/PKG-INFO`
...
### Comparing `mfprocess-0.0.4/setup.py` & `mfprocess-0.0.5/setup.py`
