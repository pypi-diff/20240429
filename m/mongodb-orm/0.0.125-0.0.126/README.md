# Comparing `tmp/mongodb_orm-0.0.125.tar.gz` & `tmp/mongodb_orm-0.0.126.tar.gz`
...
## Comparing `mongodb_orm-0.0.125.tar` & `mongodb_orm-0.0.126.tar`
...
### Comparing `mongodb_orm-0.0.125/README.md` & `mongodb_orm-0.0.126/README.md`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm/custom_urls/bread_urls.py` & `mongodb_orm-0.0.126/mongodb_orm/custom_urls/bread_urls.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm/interfaces/base_mongodb_model.py` & `mongodb_orm-0.0.126/mongodb_orm/interfaces/base_mongodb_model.py`
...
### Comparing `mongodb_orm-0.0.125/mongodb_orm/interfaces/mongodb_model.py` & `mongodb_orm-0.0.126/mongodb_orm/interfaces/mongodb_model.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm/interfaces/mongodb_model_events.py` & `mongodb_orm-0.0.126/mongodb_orm/interfaces/mongodb_model_events.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm/management/commands/update_schema.py` & `mongodb_orm-0.0.126/mongodb_orm/management/commands/update_schema.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm/utils/helpers.py` & `mongodb_orm-0.0.126/mongodb_orm/utils/helpers.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm/views/mongodb_api_model_view.py` & `mongodb_orm-0.0.126/mongodb_orm/views/mongodb_api_model_view.py`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/mongodb_orm.egg-info/SOURCES.txt` & `mongodb_orm-0.0.126/mongodb_orm.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `mongodb_orm-0.0.125/setup.py` & `mongodb_orm-0.0.126/setup.py`
