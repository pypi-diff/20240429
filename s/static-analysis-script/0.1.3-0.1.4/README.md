# Comparing `tmp/static_analysis_script-0.1.3.tar.gz` & `tmp/static_analysis_script-0.1.4.tar.gz`
...
## Comparing `static_analysis_script-0.1.3.tar` & `static_analysis_script-0.1.4.tar`
...
### Comparing `static_analysis_script-0.1.3/PKG-INFO` & `static_analysis_script-0.1.4/PKG-INFO`
...
### Comparing `static_analysis_script-0.1.3/README.md` & `static_analysis_script-0.1.4/README.md`

 * *Files identical despite different names*

### Comparing `static_analysis_script-0.1.3/setup.py` & `static_analysis_script-0.1.4/setup.py`
...
### Comparing `static_analysis_script-0.1.3/src/analysis/main.py` & `static_analysis_script-0.1.4/src/analysis/main.py`

 * *Files identical despite different names*

### Comparing `static_analysis_script-0.1.3/src/static_analysis_script.egg-info/PKG-INFO` & `static_analysis_script-0.1.4/src/static_analysis_script.egg-info/PKG-INFO`
