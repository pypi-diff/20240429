# Comparing `tmp/secretvalidate-0.0.1a7.tar.gz` & `tmp/secretvalidate-0.0.1a8.tar.gz`
...
## Comparing `secretvalidate-0.0.1a7.tar` & `secretvalidate-0.0.1a8.tar`
...
### Comparing `secretvalidate-0.0.1a7/LICENSE` & `secretvalidate-0.0.1a8/LICENSE`

 * *Files identical despite different names*

### Comparing `secretvalidate-0.0.1a7/secretvalidate/validator.py` & `secretvalidate-0.0.1a8/secretvalidate/validator.py`

 * *Files identical despite different names*

### Comparing `secretvalidate-0.0.1a7/setup.py` & `secretvalidate-0.0.1a8/setup.py`
